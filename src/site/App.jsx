...
const fade = (delay = 0) => ({ initial: { opacity: 0, y: 18 }, animate: { opacity: 1, y: 0 }, transition: { duration: .6, delay } });
    ...
    <div id="mobile-menu" className="md:hidden border-t bg-white">
      ...
      <section id="services" className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-10">
          <motion.div {...fade(.05)}>
            <h2 className="text-3xl font-bold">Services for <span className="text-indigo-600">All Small Businesses</span></h2>
            ...
            <ul className="mt-6 space-y-3">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <div className="mt-1"><Icon className="w-5 h-5 text-indigo-600"/></div>
                  <div>
          ...
          <motion.div {...fade(.1)}>
            <h2 className="text-3xl font-bold">Services for <span className="text-orange-600">Restaurants</span></h2>
            ...
            <ul className="mt-6 space-y-3">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <div className="mt-1"><Icon className="w-5 h-5 text-orange-600"/></div>
                  <div>
                    <p className="font-semibold">{title}</p>
                    <p className="text-sm text-slate-600">{sub}</p>
                  </div>
      ...
      <section id="packages" className="bg-slate-50 border-y">
        ...
        <div className="mt-10 grid md:grid-cols-3 gap-6">
          ...
          <div className="rounded-2xl bg-white shadow-sm p-6 border">
            ...
            <h3 className="text-3xl font-extrabold mt-1">$499<span className="text-base font-normal">/mo</span></h3>
            <ul className="mt-4 space-y-2 text-sm">
              {[
                ...
                <li key={i} className="flex gap-2"><Check className="w-4 h-4 mt-0.5 text-emerald-600"/>{t}</li>
              ))}
            </ul>
          </div>
          {/* Silver */}
          <div className="rounded-2xl bg-white shadow-lg p-6 border-2 border-indigo-600 relative">
            <span className="absolute -top-3 right-6 text-xs bg-indigo-600 text-white px-2 py-1 rounded-full shadow">Most Popular</span>
            <p className="text-sm font-medium text-indigo-600">Silver — Growth</p>
            <h3 className="text-3xl font-extrabold mt-1">$899<span className="text-base font-normal">/mo</span></h3>
            <ul className="mt-4 space-y-2 text-sm">
              {[
          ...
          <div className="rounded-2xl bg-white shadow-sm p-6 border">
            ...
            <h3 className="text-3xl font-extrabold mt-1">$1,499<span className="text-base font-normal">/mo</span></h3>
            <ul className="mt-4 space-y-2 text-sm">
              {[
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <div className="rounded-2xl bg-white shadow-sm p-6 border">
            ...
            <h3 className="text-3xl font-extrabold mt-1">$499 <span className="text-base font-normal">one‑time</span></h3>
            <ul className="mt-4 space-y-2 text-sm">
              {[
          ...
          <div className="rounded-2xl bg-white shadow-sm p-6 border">
            ...
            <h3 className="text-3xl font-extrabold mt-1">$699<span className="text-base font-normal">/mo</span></h3>
            <ul className="mt-4 space-y-2 text-sm">
              {[
                "5‑page site + blog",
          ...
          <div className="rounded-2xl bg-white shadow-sm p-6 border">
            ...
            <h3 className="text-3xl font-extrabold mt-1">$1,199<span className="text-base font-normal">/mo</span></h3>
            <ul className="mt-4 space-y-2 text-sm">
              {[
                "E‑commerce or booking system",
                "20 posts + ad management",
      ...
      <section id="owner" className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <motion.div {...fade(.05)}>
            <h2 className="text-3xl font-bold">Restaurant Websites & Apps with <span className="text-orange-600">Owner.com</span></h2>
            <p className="mt-2 text-slate-600">Reduce third‑party fees and own your customer data with direct ordering, reservations, and rewards.</p>
            <ul className="mt-4 space-y-2 text-sm">
              {[
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-10 items-center">
          <motion.div {...fade(.05)}>
            ...
            <ul className="mt-6 space-y-2 text-indigo-100 text-sm">
              <li className="flex gap-2"><DollarSign className="w-4 h-4 mt-0.5"/> Base fee suggestion: <b>$500 / month</b></li>
              <li className="flex gap-2"><LineChart className="w-4 h-4 mt-0.5"/> Bonus: <b>10% of monthly revenue increase</b> over baseline</li>
              <li className="flex gap-2"><CalendarDays className="w-4 h-4 mt-0.5"/> Month‑to‑month, cancel anytime with 30‑days notice</li>
            </ul>
            <div className="mt-4 text-sm text-indigo-100/90">
              <p><b>Example:</b> Baseline $30k → New $40k → Growth $10k → Bonus $1k (+ base)</p>
            </div>
          </motion.div>
          <motion.div {...fade(.1)} className="rounded-3xl bg-white/10 p-6 ring-1 ring-white/20">
            ...
            <ul className="mt-3 space-y-2 text-indigo-100 text-sm">
              {[
                ...
                <li key={i} className="flex gap-2"><Check className="w-4 h-4 mt-0.5"/>{t}</li>
              ))}
            </ul>
          </motion.div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          {["Filled our brunch hours in 3 weeks.", "Clean website, phones ringing again.", "Online orders now 40% of sales."].map((quote, i)=> (
            <div key={i} className="rounded-2xl border p-5 shadow-sm">
              <div className="flex items-center gap-1 text-amber-500 mb-2">
                {[...Array(5)].map((_,k)=> <Star key={k} className="w-4 h-4 fill-amber-500"/>) }
              </div>
      ...
      <section id="contact" className="bg-slate-50 border-t">
        <div className="max-w-6xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-2 text-slate-600">Tell us about your goals. We'll send a quick plan with timeline & pricing.</p>
            <ul className="mt-5 space-y-2 text-sm">
              <li className="flex gap-2"><Phone className="w-4 h-4 mt-0.5 text-indigo-600"/> (123) 456‑7890</li>
              <li className="flex gap-2"><Mail className="w-4 h-4 mt-0.5 text-indigo-600"/> info@technoaimarketing.com</li>
            </ul>
          </div>
          <form onSubmit={(e)=> e.preventDefault()} className="rounded-2xl bg-white p-6 shadow-sm border">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input placeholder="Full name" className="rounded-xl border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"/>
              <input placeholder="Email" className="rounded-xl border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"/>
              <input placeholder="Business name" className="rounded-xl border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 md:col-span-2"/>
              <select className="rounded-xl border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 md:col-span-2">
                <option>Service interest — select</option>
              ...
              <textarea rows={4} placeholder="Goals / questions" className="rounded-xl border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 md:col-span-2"/>
            </div>
            <button className="mt-4 w-full rounded-2xl bg-indigo-600 py-3 text-white font-semibold hover:bg-indigo-700">Send</button>
            <p className="mt-2 text-xs text-slate-500">By submitting, you agree to be contacted about your inquiry.</p>
          </form>
        </div>
      </section>

      <footer className="py-10 text-center text-sm text-slate-500">© {new Date().getFullYear()} Techno AI Marketing & IT LLC • Malvern, PA</footer>
    </div>
  );
}
